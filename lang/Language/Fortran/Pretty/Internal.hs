...
module Language.Fortran.Pretty.Internal (
  ...
  -- * Utilities
  module Language.Fortran.Pretty.Util,
) where

import Language.Fortran.Pretty.Literals
import Language.Fortran.Pretty.Util
...
printType (FProcedurePtr _ _ _ _ x)           = annotate x ( "FProcedurePtr" )
