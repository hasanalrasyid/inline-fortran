  ...
  pprint' v (Selector _ _ mLenSel mKindSel)
    ...
    | v < Fortran90 =
      case (mLenSel, mKindSel) of
        ...
        _ -> error "Kind and length selectors can be active one at a time in Fortran 77."
    ...
    | v >= Fortran90 =
      case (mLenSel, mKindSel) of
        ...
        _ -> error "No way for both kind and length selectors to be empty in Fortran 90 onwards."
